...
export function SettingRow({border = false, children}: { border?: boolean, children: React.ReactNode}) {
  return <div className={`${border ? "border-b py-4 my-4" : ""} flex justify-between text-sm items-center`}>
    {children}
  </div>
}
